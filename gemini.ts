...
export const generateTextResult = async (
  ...
  const textPrompt = `
    ...
    ТРЕБОВАНИЯ К СТРУКТУРЕ ТЕХЗАДАНИЯ (technicalAssignment):
    Используй Markdown для оформления. Текст должен быть разбит на логические блоки с подзаголовками.
    Пример структуры:
    # Концепция проекта: [Название]
    [Общее описание идеи и атмосферы]

    ## 1. Стилистическое решение
    [Описание выбранного стиля и его адаптации под объект]

    ## 2. Цветовая палитра и материалы
    [Подробности по цветам и текстурам]

    ## 3. Технические решения
    [Освещение, отопление, кондиционирование]

    ## 4. Зонирование и функционал
    [Описание кухни, спальни, санузлов и т.д.]

    Используй списки (- или *) для перечисления деталей.

    ТРЕБОВАНИЯ К ОТВЕТУ (JSON):
    1. technicalAssignment: Структурированное Markdown ТЗ.
    2. moodboardDescription: Название концепции (коротко).
